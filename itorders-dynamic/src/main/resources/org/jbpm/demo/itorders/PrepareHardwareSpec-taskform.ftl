<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("hwSpec_");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid hwSpec_");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: orderhardware.PrepareHardwareSpec
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">hwSpec_</label>
                            		<div class="div_texbox">
                              		<input name="hwSpec_" type="text" class="textbox" id="hwSpec_" value="${hwSpec_}" />
                            		</div>
